...
(function () {
  ...
  const TINTS = {
    ...
    'ניקיון וטואלטיקה': '#eaf7f5', 'מעדנייה': '#fff8e1', 'תינוקות': '#fdf1f7', 'בעלי חיים': '#f3efe6', 'בית וכלים': '#eef0f3',
  };
  const CATEGORY_ICONS = {
    'כללי': '🛒',
    'חלב וביצים': '🥛', 'ירקות ופירות': '🥬', 'בשר ועוף': '🍗', 'מאפים ולחם': '🍞', 'יבשים ואפייה': '🌾',
    'שימורים': '🥫', 'חטיפים וממתקים': '🍫', 'משקאות': '🥤', 'ניקיון וטואלטיקה': '🧴', 'מעדנייה': '🧀', 'תינוקות': '🍼', 'בעלי חיים': '🐾', 'בית וכלים': '🏠',
  };
