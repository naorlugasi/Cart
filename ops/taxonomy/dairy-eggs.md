...
- [x] **חלב גוף משזף / חלב ומי פנים בתכשיר** - נוספו `חלב גוף` ו-`מי פנים` לרשימת טיפוח ויופי (רול 1, נבדק לפני חלב וביצים).
- [x] **מונג נתחי X** - כבר נכון live (`בשר ועוף`); הממצא היה שגוי או נפתר קודם לכן - לא נדרש תיקון.
- [x] **שוק דובאי חלב** - נוסף `שוק דובאי` לחריג של רול 6 (חלב וביצים, יחד עם "שוקולד") ולרשימת חטיפים וממתקים.
- [x] **גבינת קממבר בקר / קממברט בקר בייבי / משולש קממבר צאן בקר / קממבר בקר בייבי פחם / קממבר בקר גלגל** - כבר נכון live דרך המושג `camembert-cheese`; רק "גבינת פילדלפיה...עם סלמון" עדיין היה שגוי (הבא).
- [x] **גבינת פילדלפיה 27%...עם סלמון** - נוסף שומר בלתי-מותנה ברול 5 (בשר ועוף): שם שמכיל `גבינת|פילדלפיה|קממבר|גורגונזולה|גאודה` נדחה מבשר ועוף גם כש"סלמון"/"בקר" הם strongMeatWord.
- [x] **קשקבל כבשים / מנצגו כבשים** - כבר נכון live דרך מושגים (`kashkaval-cheese` וכו') - לא נדרש תיקון.
- [x] **גבינת בורסאן פלפל שחור** - עדיין שגוי (`שימורים`, דרך קונפליקט עם המושג `spice-black-pepper`) - זה קונפליקט ברמת המושג (pantry.json), מחוץ לתחום categorize.js. נרשם כממצא פתוח.
- [x] **גבינת סנט מור פחם** - תוקן: נוסף שומר ברול 2 (ניקיון) - שם עם "פחם"+"גבינ" נדחה מניקיון, ונופל דרך ל-רול 9 (חלב וביצים) שכבר תופס "גבינ".
- [x] **פחית גרנה פדנו מגורר / טבורוג (כל הווריאציות)** - כבר נכון live דרך מושגים - לא נדרש תיקון.
