...
export const CATEGORY_RULES = [
  ...
  wordRule('מעדנייה',
    ...
    (name) => {
      ...
      if (/גלידה|שלגון|ארטיק|קרמבו|קרחון/.test(name)) return true; // ice cream is a sweet
  ...
  wordRule('חלב וביצים',
    ...
    (name) => {
      ...
      if (/גלידה|שלגון|ארטיק|קרמבו/.test(name)) return true; // ice cream is a sweet
      return false;
    }),
  ...
  wordRule('חטיפים וממתקים',
    `במבה|ביסלי|אפרופו|תפוצ'יפס|צ'יפס|חטיף|שוקולד|ממתק|סוכרי|מסטיק|ופל|וופל|טופי|קליק|פסק זמן|כיף כף|מקופלת|עלית|תפוציפס|דוריטוס|צ'יטוס|נאצ'וס|פופקורן|בוטנים|פיצוח|אגוז|שקד|קשיו${NOT_HEB_AHEAD}|פיסטוק|גרעינ|תמר|צימוק|פירות יבשים|חלבה|גלידה|שלגון|ארטיק|קרמבו|נוגט|מרשמלו|ג'לי|לקריץ|ערגליות|נשנוש|בייגלה|לעיסה|בפלות|חטיפ|טוגנ|מצופ|תפוחוני|גודיז|כיפלי|פוף${NOT_HEB_AHEAD}|קראנצ|ציפס|בזוקה|עוגיות|עוגיה|ביסקוויט|מקרון|בונבונ|חלווה|גומי|מנטוס|טיק טק|אם אנד אמס|טים טם|קרמוגית|בישקוטים|אפיפיות|בראוני|דרז'ה|מקלות מלוחים|חיספוסים|נוגטין|לחמית שוקולד`,
    (name) => {
