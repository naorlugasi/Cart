...
export const CATEGORY_RULES = [
  ...
  // 2. Housewares, textile, furniture, tools, electronics: the home department (23.9; Shufersal "מטבח, אירוח",
  //    "חדר שינה", "DIY", "אלקטרוניקה", Rami Levy "הכל לבית / מוצרי חשמל"). Cleaning tools stay in rule 1.
  wordRule('בית וכלים',
  ...
  // 3. What is left that is not food: supplements, over-the-counter health, optics.
  wordRule('כללי',
    `ויטמין|תוסף תזונה|אומגה|מגנזיום|פרוביוטי|משקפי|מד חום|מד לחץ|אינהלציה|ממתיק`),
  // 4. Drinks - anything you drink or dilute to drink, coffee and tea included. A milk-based drink is left to
